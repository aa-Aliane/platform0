...
export const usePreviews = create((set) => ({
  previews: [],
  init_previews : (previews: boolean[]) => set((state:any) => ({previews: previews})),
  add_preview : (preview: boolean) => set((state:any) => ({previews: [...state.previews, preview]})),
  change_preview: (index: number) => set((state:any) => ({
